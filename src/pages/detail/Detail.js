...
class Detail extends PureComponent {
    ...
    _onSend = () => {
        const { accesstoken, user, content, reply_id, data,tab } = this.props
        const params = { content, user, accesstoken, topic_id: data.id ,tab}
...
function mapStateToProps(state) {
    ...
    const { accesstoken, user ,tab} = state.home
    return { data, accesstoken, loading, content, replies, reply_id, user,tab };
}
